...
class ItemBasedRecommender:
    ...
    def fit(aux, *, track_ids, train_data, tgt_tracks=None, idf=False, measure='dot', shrinkage=0, n_el_sim=20):
        ...
        if ItemBasedRecommender.IX_tgt_items is not None:
            ItemBasedRecommender.S = rs.create_Smatrix(model_URM, n_el_sim, measure, shrinkage, ItemBasedRecommender.IX_tgt_items, ItemBasedRecommender.IX_items)
        else:
